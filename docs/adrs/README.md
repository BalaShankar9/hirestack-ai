...
| 0032 | Capability tokens for tools (P0-5) | Proposed | `m7-pr29` |
| 0033 | Tool sandbox tier classifier (L0/L1/L2) | Proposed | `m7-pr29` |
...
| 0038 | Eliminate in-process job fallback (P0-2) | Proposed | `m7-pr27` |
