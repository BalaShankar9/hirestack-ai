...
# m12-pr19 (TD-1 first cut): pure helpers for module-state / preferred-lock
# normalisation moved to a sibling module. Re-imported here so the
# legacy import path `app.api.routes.generate.jobs._foo` continues to
