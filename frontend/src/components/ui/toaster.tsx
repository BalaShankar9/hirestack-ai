...
>(({ className, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(
        "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-2xl border p-5 pr-8 shadow-soft-lg transition-all",
...
export { Toast, ToastClose, ToastDescription, ToastTitle, ToastProvider };
